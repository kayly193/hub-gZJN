...
3. 引用具体数据时，在句末标注来源文件名，如：市场规模达500亿元（来源：2023手游白皮书）
4. 数字要精确，回答简洁，重点突出"""
...
def main():
    parser = argparse.ArgumentParser(description="游戏行业报告 RAG 问答（LangChain LCEL 版）")
    ...
    if args.query:
        ...
        print(f"游戏行业报告 RAG 问答系统（LangChain LCEL 版）")
