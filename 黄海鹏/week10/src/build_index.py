...
# API Host
# llm-8mouh298wztd9f8w.cn-beijing.maas.aliyuncs.com
# OpenAI 兼容地址
# https://llm-8mouh298wztd9f8w.cn-beijing.maas.aliyuncs.com/compatible-mode/v1
# DashScope
# https://llm-8mouh298wztd9f8w.cn-beijing.maas.aliyuncs.com/api/v1
...
def build_chroma_index(chunks: list[dict], client: OpenAI):
    """
    ChromaDB 版本（可选）。
    优势：内置元数据过滤，可直接 where={"source": "手游白皮书"} 过滤。
    劣势：写入较慢，不适合大批量。
    """
    try:
        import chromadb
