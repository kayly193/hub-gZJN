...
# 设置 HuggingFace 国内镜像（必须在导入 transformers 之前设置）
...
def parse_args():
    parser = argparse.ArgumentParser(description="训练 BERT NER 模型（peoples_daily数据集）")
